...
if(count($_GET)!=2 || !isset($_GET[1]) || !isset($_GET[2])){
  ...
  include 'serverCall/valF.php';
	...
	mysql_query($sentencia, $iden);
	$sentencia = "INSERT INTO $db.CM_CR_MOVES(USER_ID, MOVE_DTTM, MOVE_CD, DESCR, SILVER, GOLD, TOT_GOLD, TOT_SILVER) VALUES ('$id',NOW(),'C','ACN GAMES le envia credito',$SILVER_INIT,$GOLD_INIT,$GOLD_INIT,$SILVER_INIT)";
	mysql_query($sentencia, $iden);
